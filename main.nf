...
Channel 
    ...
    .splitCsv(skip:1)
    .map{tumour_sample_platekey, somatic_small_variants_vcf_path,somatic_cnv_vcf -> [tumour_sample_platekey, file(somatic_cnv_vcf), file(somatic_small_variants_vcf_path)]}
    .set{ ch_input }
